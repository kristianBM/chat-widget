  ...
  e: if (typeof L == "function") try {
    if (m = t.props, w = L.prototype && L.prototype.render, g = (u = L.contextType) && n[u.__c], b = u ? g ? g.props.value : u.__ : n, r.__c ? x = (i = t.__c = r.__c).__ = i.__E : (w ? t.__c = i = new L(m, b) : (t.__c = i = new ee(m, b), i.constructor = L, i.render = kt), g && g.sub(i), i.state || (i.state = {}), i.__n = n, f = i.__d = !0, i.__h = [], i._sb = []), w && i.__s == null && (i.__s = i.state), w && L.getDerivedStateFromProps != null && (i.__s == i.state && (i.__s = D({}, i.__s)), D(i.__s, L.getDerivedStateFromProps(m, i.__s))), h = i.props, p = i.state, i.__v = t, f) w && L.getDerivedStateFromProps == null && i.componentWillMount != null && i.componentWillMount(), w && i.componentDidMount != null && i.__h.push(i.componentDidMount);
      ...
      if (w && L.getDerivedStateFromProps == null && m !== h && i.componentWillReceiveProps != null && i.componentWillReceiveProps(m, b), t.__v == r.__v || !i.__e && i.shouldComponentUpdate != null && i.shouldComponentUpdate(m, i.__s, b) === !1) {
        t.__v != r.__v && (i.props = m, i.state = i.__s, i.__d = !1), t.__e = r.__e, t.__k = r.__k, t.__k.some(function(A) {
          A && (A.__ = t);
    ...
    if (t.__v = null, _ || o != null) if (A.then) {
    ...
    else t.__e = r.__e, t.__k = r.__k, A.then || me(t);
    v.__e(A, t, r);
  }
...
function At({ title: e, subtitle: t, botName: r, botAvatar: n, i18n: a, onClose: o, onNewConversation: s }) {
...
function Gt({ onSend: e, disabled: t, placeholder: r }) {
  const n = W(null), a = W(null), [o, s] = z([]), [d, _] = z(!1), [c, u] = z(""), i = $(() => {
    const g = n.current;
...
function ar(e) {
  const {
    ...
    onMessage: w,
    onError: g
  } = e, [b, S] = z(_), [M, T] = z([]), [R, L] = z(!1), [A, ce] = z(!1), [pt, le] = z(0), [K, Le] = z(() => qe()), de = W(b);
  N(() => {
    de.current = b;
  }, [b]), N(() => {
    if (c) {
  ...
  const Te = $(() => {
    ...
    if (!(!!I && I.trim().length > 0) && j.length === 0 || A) return;
    const gt = {
      id: re(),
      role: "user",
      content: I || "",
    ...
    try {
      const H = await Zt({
        ...
        headers: f,
        requestPayload: h
      }), pe = Date.now() - Ae, F = Math.max(0, i - pe);
      ...
      const pe = Date.now() - Ae, F = Math.max(0, Math.min(i, 1200) - pe);
      F > 0 && await new Promise((P) => setTimeout(P, F));
      const ue = {
        id: re(),
        role: "bot",
  ...
  }, [s]), je = (p == null ? void 0 : p.position) || "bottom-right", wt = `cw-root--${["bottom-right", "bottom-left", "top-right", "top-left"].includes(je) ? je : "bottom-right"}`, ze = p == null ? void 0 : p.darkMode;
  return /* @__PURE__ */ l(
    "div",
    {
      class: ["cw-root", wt, ze === !0 ? "cw-root--dark" : ze === !1 ? "cw-root--light" : "", b ? "cw-root--open" : ""].filter(Boolean).join(" "),
      style: {
