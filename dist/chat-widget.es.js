var ie, b, qe, j, ze, Je, Ke, ue, X, Y, Ge, xe, he, ge, re = {}, oe = [], ut = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, ae = Array.isArray;
function L(e, t) {
...
function Q(e, t, r, n, i) {
  var o = { type: e, props: t, key: r, ref: n, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: i ?? ++qe, __i: -1, __u: 0 };
...
function wt(e) {
  if (e.__P && e.__d) {
    var t = e.__v, r = t.__e, n = [], i = [], o = L({}, t);
    o.__v = t.__v + 1, b.vnode && b.vnode(o), ke(e.__P, o, t, e.__n, e.__P.namespaceURI, 32 & t.__u ? [r] : null, n, r ?? W(t), !!(32 & t.__u), i), o.__v = t.__v, o.__.__k[o.__i] = o, et(n, o, i), t.__e = t.__ = null, o.__e != r && Xe(o);
  }
}
function Xe(e) {
...
function Pe(e) {
  (!e.__d && (e.__d = !0) && j.push(e) && !ne.__r++ || ze != b.debounceRendering) && ((ze = b.debounceRendering) || Je)(ne);
}
function ne() {
  try {
    for (var e, t = 1; j.length; ) j.length > t && j.sort(Ke), e = j.shift(), t = j.length, wt(e);
  } finally {
    j.length = ne.__r = 0;
  }
}
function Qe(e, t, r, n, i, o, s, l, _, c, u) {
  var a, w, f, d, v, m, g, h = n && n.__k || oe, k = t.length;
  for (_ = ht(r, t, h, _, k), a = 0; a < k; a++) (f = r.__k[a]) != null && (w = f.__i != -1 && h[f.__i] || re, f.__i = a, m = ke(e, f, w, i, o, s, l, _, c, u), d = f.__e, f.ref && w.ref != f.ref && (w.ref && Ce(w.ref, null, f), u.push(f.ref, f.__c || d, f)), v == null && d != null && (v = d), (g = !!(4 & f.__u)) || w.__k === f.__k ? (_ = Ze(f, _, e, g), g && w.__e && (w.__e = null)) : typeof f.type == "function" && m !== void 0 ? _ = m : d && (_ = d.nextSibling), f.__u &= -7);
  return r.__e = v, _;
}
function ht(e, t, r, n, i) {
  var o, s, l, _, c, u = r.length, a = u, w = 0;
  for (e.__k = new Array(i), o = 0; o < i; o++) (s = t[o]) != null && typeof s != "boolean" && typeof s != "function" ? (typeof s == "string" || typeof s == "number" || typeof s == "bigint" || s.constructor == String ? s = e.__k[o] = Q(null, s, null, null, null) : ae(s) ? s = e.__k[o] = Q(se, { children: s }, null, null, null) : s.constructor === void 0 && s.__b > 0 ? s = e.__k[o] = Q(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v) : e.__k[o] = s, _ = o + w, s.__ = e, s.__b = e.__b + 1, l = null, (c = s.__i = gt(s, r, _, a)) != -1 && (a--, (l = r[c]) && (l.__u |= 2)), l == null || l.__v == null ? (c == -1 && (i > u ? w-- : i < u && w++), typeof s.type != "function" && (s.__u |= 4)) : c != _ && (c == _ - 1 ? w-- : c == _ + 1 ? w++ : (c > _ ? w-- : w++, s.__u |= 4))) : e.__k[o] = null;
  if (a) for (o = 0; o < u; o++) (l = r[o]) != null && !(2 & l.__u) && (l.__e == n && (n = W(l)), rt(l, l));
  return n;
}
function Ze(e, t, r, n) {
  var i, o;
  if (typeof e.type == "function") {
    for (i = e.__k, o = 0; i && o < i.length; o++) i[o] && (i[o].__ = e, t = Ze(i[o], t, r, n));
    return t;
  }
...
function je(e, t, r) {
  t[0] == "-" ? e.setProperty(t, r ?? "") : e[t] = r == null ? "" : typeof r != "number" || ut.test(t) ? r : r + "px";
}
function V(e, t, r, n, i) {
  var o, s;
  e: if (t == "style") if (typeof r == "string") e.style.cssText = r;
  else {
    if (typeof n == "string" && (e.style.cssText = n = ""), n) for (t in n) r && t in r || je(e.style, t, "");
    if (r) for (t in r) n && r[t] == n[t] || je(e.style, t, r[t]);
  }
  else if (t[0] == "o" && t[1] == "n") o = t != (t = t.replace(Ge, "$1")), s = t.toLowerCase(), t = s in e || t == "onFocusOut" || t == "onFocusIn" ? s.slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + o] = r, r ? n ? r[Y] = n[Y] : (r[Y] = xe, e.addEventListener(t, o ? ge : he, o)) : e.removeEventListener(t, o ? ge : he, o);
  else {
...
function ke(e, t, r, n, i, o, s, l, _, c) {
  var u, a, w, f, d, v, m, g, h, k, M, z, T, $, F, C = t.type;
  if (t.constructor !== void 0) return null;
  128 & r.__u && (_ = !!(32 & r.__u), o = [l = t.__e = r.__e]), (u = b.__b) && u(t);
  e: if (typeof C == "function") try {
    if (g = t.props, h = C.prototype && C.prototype.render, k = (u = C.contextType) && n[u.__c], M = u ? k ? k.props.value : u.__ : n, r.__c ? m = (a = t.__c = r.__c).__ = a.__E : (h ? t.__c = a = new C(g, M) : (t.__c = a = new Z(g, M), a.constructor = C, a.render = mt), k && k.sub(a), a.state || (a.state = {}), a.__n = n, w = a.__d = !0, a.__h = [], a._sb = []), h && a.__s == null && (a.__s = a.state), h && C.getDerivedStateFromProps != null && (a.__s == a.state && (a.__s = L({}, a.__s)), L(a.__s, C.getDerivedStateFromProps(g, a.__s))), f = a.props, d = a.state, a.__v = t, w) h && C.getDerivedStateFromProps == null && a.componentWillMount != null && a.componentWillMount(), h && a.componentDidMount != null && a.__h.push(a.componentDidMount);
    else {
      if (h && C.getDerivedStateFromProps == null && g !== f && a.componentWillReceiveProps != null && a.componentWillReceiveProps(g, M), t.__v == r.__v || !a.__e && a.shouldComponentUpdate != null && a.shouldComponentUpdate(g, a.__s, M) === !1) {
      ...
      a.componentWillUpdate != null && a.componentWillUpdate(g, a.__s, M), h && a.componentDidUpdate != null && a.__h.push(function() {
        a.componentDidUpdate(f, d, v);
      });
    }
    if (a.context = M, a.props = g, a.__P = e, a.__e = !1, z = b.__r, T = 0, h) a.state = a.__s, a.__d = !1, z && z(t), u = a.render(a.props, a.state, a.context), oe.push.apply(a.__h, a._sb), a._sb = [];
    else do
      a.__d = !1, z && z(t), u = a.render(a.props, a.state, a.context), a.state = a.__s;
    while (a.__d && ++T < 25);
    a.state = a.__s, a.getChildContext != null && (n = L(L({}, n), a.getChildContext())), h && !w && a.getSnapshotBeforeUpdate != null && (v = a.getSnapshotBeforeUpdate(f, d)), $ = u != null && u.type === se && u.key == null ? tt(u.props.children) : u, l = Qe(e, ae($) ? $ : [$], t, r, n, i, o, s, l, _, c), a.base = t.__e, t.__u &= -161, a.__h.length && s.push(a), m && (a.__E = a.__ = null);
  } catch (I) {
    if (t.__v = null, _ || o != null) if (I.then) {
      ...
      for (F = o.length; F--; ) ye(o[F]);
      be(t);
    }
    else t.__e = r.__e, t.__k = r.__k, I.then || be(t);
    b.__e(I, t, r);
  }
  else o == null && t.__v == r.__v ? (t.__k = r.__k, t.__e = r.__e) : l = t.__e = bt(r.__e, t, r, n, i, o, s, _, c);
...
function tt(e) {
  return typeof e != "object" || e == null || e.__b > 0 ? e : ae(e) ? e.map(tt) : L({}, e);
}
function bt(e, t, r, n, i, o, s, l, _) {
  ...
  if (h == null) m === g || l && e.data == g || (e.data = g);
    ...
    for (c in m) f = m[c], c == "dangerouslySetInnerHTML" ? a = f : c == "children" || c in g || c == "value" && "defaultValue" in g || c == "checked" && "defaultChecked" in g || V(e, c, null, f, i);
    for (c in g) f = g[c], c == "children" ? w = f : c == "dangerouslySetInnerHTML" ? u = f : c == "value" ? d = f : c == "checked" ? v = f : l && typeof f != "function" || m[c] === f || V(e, c, f, m[c], i);
    if (u) l || a && (u.__html == a.__html || u.__html == e.innerHTML) || (e.innerHTML = u.__html), t.__k = [];
    else if (a && (e.innerHTML = ""), Qe(t.type == "template" ? e.content : e, ae(w) ? w : [w], t, r, n, h == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, o, s, o ? o[0] : r.__k && W(r, 0), l, _), o != null) for (c = o.length; c--; ) ye(o[c]);
    l || (c = "value", h == "progress" && d == null ? e.removeAttribute("value") : d != null && (d !== e[c] || h == "progress" && !d || h == "option" && d != m[c]) && V(e, c, d, m[c], i), c = "checked", v != null && v != e[c] && V(e, c, v, m[c], i));
  }
  return e;
}
function Ce(e, t, r) {
...
function rt(e, t, r) {
  var n, i;
  if (b.unmount && b.unmount(e), (n = e.ref) && (n.current && n.current != e.__e || Ce(n, null, t)), (n = e.__c) != null) {
  ...
  if (n = e.__k) for (i = 0; i < n.length; i++) n[i] && rt(n[i], t, r || typeof e.type != "function");
  r || ye(e.__e), e.__c = e.__ = e.__e = void 0;
}
function mt(e, t, r) {
...
function ot(e, t, r) {
  var n, i, o, s;
  t == document && (t = document.documentElement), b.__ && b.__(e, t), i = (n = !1) ? null : t.__k, o = [], s = [], ke(t, e = t.__k = Ve(se, null, [e]), i || re, re, t.namespaceURI, i ? null : t.firstChild ? ie.call(t.childNodes) : null, o, i ? i.__e : t.firstChild, n, s), et(o, e, s);
}
ie = oe.slice, b = { __e: function(e, t, r, n) {
  ...
  throw e;
} }, qe = 0, Z.prototype.setState = function(e, t) {
  var r;
  r = this.__s != null && this.__s != this.state ? this.__s : this.__s = L({}, this.state), typeof e == "function" && (e = e(L({}, r), this.props)), e && L(r, e), e != null && this.__v && (t && this._sb.push(t), Pe(this));
}, Z.prototype.forceUpdate = function(e) {
  this.__v && (this.__e = !0, e && this.__h.push(e), Pe(this));
}, Z.prototype.render = se, j = [], Je = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ke = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, ne.__r = 0, ue = Math.random().toString(8), X = "__d" + ue, Y = "__a" + ue, Ge = /(PointerCapture)$|Capture$/i, xe = 0, he = He(!1), ge = He(!0);
var vt = 0;
function p(e, t, r, n, i, o) {
  t || (t = {});
  var s, l, _ = t;
  if ("ref" in _) for (l in _ = {}, t) l == "ref" ? s = t[l] : _[l] = t[l];
  var c = { type: e, props: _, key: r, ref: s, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --vt, __i: -1, __u: 0, __source: i, __self: o };
  if (typeof e == "function" && (s = e.defaultProps)) for (l in s) _[l] === void 0 && (_[l] = s[l]);
  return b.vnode && b.vnode(c), c;
}
var q, x, we, Ne, J = 0, nt = [], y = b, Ae = y.__b, Ee = y.__r, Ue = y.diffed, Be = y.__c, We = y.unmount, Fe = y.__;
function Se(e, t) {
...
function xt(e, t, r) {
  var n = Se(q++, 2);
  if (n.t = e, !n.__c && (n.__ = [st(void 0, t), function(l) {
...
function B(e, t) {
  var r = Se(q++, 3);
  !y.__s && at(r.__H, t) && (r.__ = e, r.u = t, x.__H.__h.push(r));
}
function K(e) {
...
function it(e, t) {
  var r = Se(q++, 7);
  return at(r.__H, t) && (r.__ = e(), r.__H = t, r.__h = e), r.__;
}
function D(e, t) {
...
y.__b = function(e) {
  ...
  Ue && Ue(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (nt.push(t) !== 1 && Ne === y.requestAnimationFrame || ((Ne = y.requestAnimationFrame) || kt)(yt)), t.__H.__.some(function(r) {
...
function kt(e) {
  var t, r = function() {
    clearTimeout(n), Re && cancelAnimationFrame(t), setTimeout(e);
  }, n = setTimeout(r, 35);
  Re && (t = requestAnimationFrame(r));
}
function ee(e) {
  var t = x, r = e.__c;
...
function Mt({ isOpen: e, unreadCount: t, bubbleIcon: r, onClick: n }) {
  return /* @__PURE__ */ p(
    "button",
    {
      class: "cw-bubble",
      ...
      "aria-expanded": e,
      children: [
        r && !e ? /* @__PURE__ */ p("img", { src: r, alt: "", class: "cw-bubble__img" }) : e ? /* @__PURE__ */ p(St, {}) : /* @__PURE__ */ p(Ct, {}),
...
function It({ title: e, subtitle: t, botName: r, botAvatar: n, i18n: i, onClose: o, onNewConversation: s }) {
...
function Lt({ role: e, content: t, isError: r, timestamp: n, showTimestamps: i, hideAvatar: o, botName: s, botAvatar: l }) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ p("div", { class: "cw-message__body", children: [
          /* @__PURE__ */ p("div", { class: "cw-message__bubble", children: t }),
          i && n && /* @__PURE__ */ p("time", { class: "cw-message__time", dateTime: new Date(n).toISOString(), children: Dt(n) })
        ] })
      ]
    }
  );
}
function zt({ botName: e, botAvatar: t }) {
...
function Pt({ messages: e, isTyping: t, showTimestamps: r, botName: n, botAvatar: i }) {
  const o = K(null);
  return B(() => {
    ...
    t && /* @__PURE__ */ p(zt, { botName: n, botAvatar: i }),
...
function Ht({ onSend: e, disabled: t, placeholder: r }) {
  const n = K(null), i = D(() => {
    const _ = n.current;
...
async function At({ webhookUrl: e, sessionId: t, message: r, headers: n = {}, requestPayload: i = {} }) {
...
function ve(e) {
  ...
  if (Array.isArray(e))
    return e.length === 0 ? "No response received." : ve(e[0]);
...
function Bt(e, t) {
  try {
    const r = t.slice(-Et);
    localStorage.setItem(Me, JSON.stringify({ sessionId: e, messages: r }));
  } catch {
  }
}
function Wt() {
...
function Rt(e) {
  const {
    ...
    onMessage: h,
    onError: k
  } = e, [M, z] = H(_), [T, $] = H([]), [F, C] = H(!1), [I, ce] = H(!1), [lt, le] = H(0), [G, Te] = H(() => Oe()), _e = K(M);
  B(() => {
    _e.current = M;
  }, [M]), B(() => {
    if (c) {
      ...
      if (S && S.messages.length > 0) {
        Te(S.sessionId), $(S.messages.map((P) => ({
          ...P,
  ...
  B(() => {
    const S = $e.current;
    if ($e.current = T.length, !_e.current && T.length > S) {
      const P = T.slice(S).filter((E) => E.role === "bot").length;
      P > 0 && le((E) => E + P);
    }
  }, [T]);
  const Ie = D(() => {
    ...
    $((U) => [...U, P]), C(!0), ce(!0), typeof h == "function" && h({ role: "user", content: S });
    const E = Date.now();
    try {
      const U = await At({
        webhookUrl: t,
        ...
        headers: w,
        requestPayload: f
      }), pe = Date.now() - E, R = Math.max(0, a - pe);
      R > 0 && await new Promise((A) => setTimeout(A, R));
      const fe = {
        id: te(),
        role: "bot",
        content: U,
      ...
      $((A) => [...A, fe]), typeof h == "function" && h({ role: "bot", content: U });
    } catch (U) {
      const pe = Date.now() - E, R = Math.max(0, Math.min(a, 1200) - pe);
      R > 0 && await new Promise((A) => setTimeout(A, R));
      const fe = {
        id: te(),
        role: "bot",
      ...
      $((A) => [...A, fe]), typeof k == "function" && k(U);
    } finally {
      C(!1), ce(!1);
    }
  }, [t, G, w, f, a, I, h, k]), pt = D(() => {
    const S = Oe();
    Te(S), Wt(), $(Ye(s)), le(0), C(!1), ce(!1);
  }, [s]), De = (d == null ? void 0 : d.position) || "bottom-right", ft = `cw-root--${["bottom-right", "bottom-left", "top-right", "top-left"].includes(De) ? De : "bottom-right"}`, Le = d == null ? void 0 : d.darkMode;
  return /* @__PURE__ */ p(
    "div",
    {
      class: ["cw-root", ft, Le === !0 ? "cw-root--dark" : Le === !1 ? "cw-root--light" : ""].filter(Boolean).join(" "),
      style: {
...
function qt(e = {}) {
  ...
  ct(), Yt(e.customCSS || ""), N = document.createElement("div"), N.setAttribute("id", "chat-widget-root"), document.body.appendChild(N), ot(Ve(Rt, e), N);
}
function ct() {
  N && (ot(null, N), N.remove(), N = null);
}
typeof window < "u" && (window.ChatWidget = { create: qt, destroy: ct });
export {
  qt as create,
  ct as destroy
};
